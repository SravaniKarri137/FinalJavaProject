...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .csrf().disable()
            .authorizeRequests()
            .requestMatchers("/api/auth/**","/api/reviews/product/**").permitAll() 
            .requestMatchers("/api/cart/checkout").authenticated()// Auth routes
            .requestMatchers("/api/products/add","/api/products/update/**", "/api/orders/admin/**","/api/orders/admin","/api/products/delete/**","/api/coupons","api/orders/admin/all-orders","/api/coupons/update/**","/api/coupons/add","/api/transactions/all","api/orders/cancel/approve/**","api/orders/cancel/reject/**").hasRole("ADMIN") // Admin routes
            .requestMatchers("/api/products/**").permitAll() // Public access
            .requestMatchers("/api/cart/get").authenticated() 
